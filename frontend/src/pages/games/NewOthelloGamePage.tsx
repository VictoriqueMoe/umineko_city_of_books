...
export function NewOthelloGamePage() {
    usePageTitle("New Othello Game");
    ...
    async function handleInvite() {
        ...
        setError("");
        try {
            const room = await inviteMutation.mutateAsync({ opponentId: selected.id, gameType: "othello" });
            navigate(`/games/othello/${room.id}`);
        } catch (err) {
    ...
    return (
        <div className={styles.page}>
            <h2 className={styles.heading}>New Othello Game</h2>
