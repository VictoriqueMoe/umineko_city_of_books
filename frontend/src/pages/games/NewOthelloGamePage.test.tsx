...
import { NewOthelloGamePage } from "./NewOthelloGamePage";
...
function renderPage() {
    return renderWithProviders(<NewOthelloGamePage />, { user: viewer, route: "/games/othello/new" });
}
...
describe("NewOthelloGamePage", () => {
    ...
    it("invites the chosen opponent to an othello game and opens the new room", async () => {
        // given
        ...
        // then
        expect(mutateAsync).toHaveBeenCalledWith({ opponentId: "user-1", gameType: "othello" });
        expect(navigate).toHaveBeenCalledWith("/games/othello/room-9");
    });
