...
import { NewCheckersGamePage } from "./NewCheckersGamePage";
...
function renderPage() {
    return renderWithProviders(<NewCheckersGamePage />, { user: viewer, route: "/games/checkers/new" });
}
...
describe("NewCheckersGamePage", () => {
    ...
    it("invites the chosen opponent to a checkers game and opens the new room", async () => {
        // given
        ...
        // then
        expect(mutateAsync).toHaveBeenCalledWith({ opponentId: "user-1", gameType: "checkers" });
