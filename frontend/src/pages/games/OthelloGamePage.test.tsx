...
describe("OthelloGamePage", () => {
    ...
    it("holds a declined invite back from the board, which never got a state", () => {
        ...
        expect(screen.queryByLabelText("othello board")).not.toBeInTheDocument();
    });
    ...
    it("tells the invitee which colour they will play", () => {
        ...
        // then
        expect(screen.getByText(/has invited you to an othello game/)).toHaveTextContent(
            "Battler has invited you to an othello game. Accept to start - you will play as white.",
        );
