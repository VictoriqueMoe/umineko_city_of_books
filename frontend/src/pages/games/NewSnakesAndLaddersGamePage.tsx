...
export function NewSnakesAndLaddersGamePage() {
    usePageTitle("New Snakes & Ladders Game");
    ...
    async function handleInvite() {
        ...
        try {
            const room = await inviteMutation.mutateAsync({ opponentId: selected.id, gameType: "snakes_and_ladders" });
            navigate(`/games/snakes_and_ladders/${room.id}`);
        } catch (err) {
    ...
    return (
        <div className={styles.page}>
            <h2 className={styles.heading}>New Snakes & Ladders Game</h2>
