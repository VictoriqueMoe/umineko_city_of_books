    ...
    return (
        <div className={styles.page}>
            ...
            <InfoPanel title="Share Your Ideas">
                <p>
                    This site is built and maintained by a single developer. This is your space to suggest
                    improvements, report issues, and share ideas. Every post here is read personally. Whether
                    it is a feature request, a quality of life tweak, or just something you think could be
                    better, drop it here.
                </p>
            </InfoPanel>
            ...
            {!feed.loading && feed.posts.map(post => (
