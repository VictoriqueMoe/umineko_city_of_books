...
func TestChatRepository_GetRoomSendContext(t *testing.T) {
	tests := []struct {
		name           string
...
func TestChatRepository_GetRoomSendContext_DMRoom(t *testing.T) {
	// given
	repos := repotest.NewRepos(t)
	ctx := context.Background()
...
func TestChatRepository_GetRoomSendContext_NotFound(t *testing.T) {
	// given
	repos := repotest.NewRepos(t)
	ctx := context.Background()
...
func TestChatRepository_GetRoomSendContext_MatchesGetRoomByID(t *testing.T) {
	// given
	repos := repotest.NewRepos(t)
	ctx := context.Background()
	creator := repotest.CreateUser(t, repos)
