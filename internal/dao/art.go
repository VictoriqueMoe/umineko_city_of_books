...
func (r *artDAO) ListAll(ctx context.Context, viewerID uuid.UUID, corner string, artType string, search string, tag string, sort string, limit, offset int, excludeUserIDs []uuid.UUID) ([]model.ArtRow, int, error) {
	...
	buildWhere := func(startIdx int) (string, []interface{}, int) {
		...
		exclSQL, exclArgs := repository.ExcludeClause("a.user_id", excludeUserIDs, idx)
		idx += len(exclArgs)
...
func (r *artDAO) Like(ctx context.Context, userID uuid.UUID, artID uuid.UUID) error {
...
func (r *artDAO) Unlike(ctx context.Context, userID uuid.UUID, artID uuid.UUID) error {
	_, err := r.db.ExecContext(ctx,
...
func (r *artDAO) GetLikedBy(ctx context.Context, artID uuid.UUID, excludeUserIDs []uuid.UUID) ([]model.PostLikeUser, error) {
	exclSQL, exclArgs := repository.ExcludeClause("al.user_id", excludeUserIDs, 2)
...
func (r *artDAO) RecordView(ctx context.Context, artID uuid.UUID, viewerHash string) (bool, error) {
...
func (r *artDAO) CreateComment(ctx context.Context, id uuid.UUID, artID uuid.UUID, parentID *uuid.UUID, userID uuid.UUID, body string) error {
	_, err := r.db.ExecContext(ctx,
...
func (r *artDAO) UpdateComment(ctx context.Context, id uuid.UUID, userID uuid.UUID, body string) error {
	return r.updateArtComment(ctx, id, &userID, body)
}

func (r *artDAO) UpdateCommentAsAdmin(ctx context.Context, id uuid.UUID, body string) error {
	return r.updateArtComment(ctx, id, nil, body)
}

func (r *artDAO) updateArtComment(ctx context.Context, id uuid.UUID, userID *uuid.UUID, body string) error {
	var res sql.Result
	var err error
	if userID != nil {
		res, err = r.db.ExecContext(ctx,
...
func (r *artDAO) DeleteComment(ctx context.Context, id uuid.UUID, userID uuid.UUID) error {
...
func (r *artDAO) DeleteCommentAsAdmin(ctx context.Context, id uuid.UUID) error {
...
func (r *artDAO) GetComments(ctx context.Context, artID uuid.UUID, viewerID uuid.UUID, limit, offset int, excludeUserIDs []uuid.UUID) ([]model.ArtCommentRow, int, error) {
	var total int
...
func (r *artDAO) GetCommentArtID(ctx context.Context, commentID uuid.UUID) (uuid.UUID, error) {
	var artID uuid.UUID
...
func (r *artDAO) GetCommentAuthorID(ctx context.Context, commentID uuid.UUID) (uuid.UUID, error) {
	var userID uuid.UUID
...
func (r *artDAO) LikeComment(ctx context.Context, userID uuid.UUID, commentID uuid.UUID) error {
	_, err := r.db.ExecContext(ctx,
...
func (r *artDAO) UnlikeComment(ctx context.Context, userID uuid.UUID, commentID uuid.UUID) error {
	_, err := r.db.ExecContext(ctx,
...
func (r *artDAO) AddCommentMedia(ctx context.Context, commentID uuid.UUID, mediaURL string, mediaType string, thumbnailURL string, sortOrder int) (int64, error) {
	var id int64
	err := r.db.QueryRowContext(ctx,
...
func (r *artDAO) GetCommentMedia(ctx context.Context, commentID uuid.UUID) ([]model.PostMediaRow, error) {
	rows, err := r.db.QueryContext(ctx,
...
func (r *artDAO) GetCommentMediaBatch(ctx context.Context, commentIDs []uuid.UUID) (map[uuid.UUID][]model.PostMediaRow, error) {
	if len(commentIDs) == 0 {
		return nil, nil
	}
...
func (r *artDAO) UpdateCommentMediaURL(ctx context.Context, id int64, mediaURL string) error {
...
func (r *artDAO) UpdateCommentMediaThumbnail(ctx context.Context, id int64, thumbnailURL string) error {
