...
func TestStatsDAO_GetOverview_EmptyDB(t *testing.T) {
	// given
...
func TestStatsDAO_GetOverview_TotalsAreCorrect(t *testing.T) {
	// given
	repos := daotest.NewRepos(t)
	db := repos.DB()
...
func TestStatsDAO_GetOverview_TimeRangeFilters(t *testing.T) {
	// given
	repos := daotest.NewRepos(t)
	db := repos.DB()
...
func TestStatsDAO_GetOverview_PostsByCorner(t *testing.T) {
	// given
	repos := daotest.NewRepos(t)
	db := repos.DB()
	user := daotest.CreateUser(t, repos)
...
func TestStatsDAO_GetOverview_CountsUsersOnly(t *testing.T) {
	// given
	repos := daotest.NewRepos(t)
...
func TestStatsDAO_GetMostActiveUsers_Empty(t *testing.T) {
	// given
	repos := daotest.NewRepos(t)
...
func TestStatsDAO_GetMostActiveUsers_OrdersByActionCount(t *testing.T) {
	// given
	repos := daotest.NewRepos(t)
	db := repos.DB()
	alice := daotest.CreateUser(t, repos, daotest.WithDisplayName("Alice"))
	bob := daotest.CreateUser(t, repos, daotest.WithDisplayName("Bob"))
	carol := daotest.CreateUser(t, repos, daotest.WithDisplayName("Carol"))
...
func TestStatsDAO_GetMostActiveUsers_RespectsLimit(t *testing.T) {
	// given
	repos := daotest.NewRepos(t)
	db := repos.DB()
	for range 5 {
		u := daotest.CreateUser(t, repos)
...
func TestStatsDAO_GetMostActiveUsers_OmitsUsersWithNoActions(t *testing.T) {
	// given
	repos := daotest.NewRepos(t)
	db := repos.DB()
	active := daotest.CreateUser(t, repos, daotest.WithDisplayName("Active"))
	daotest.CreateUser(t, repos, daotest.WithDisplayName("Idle"))
...
func TestStatsDAO_GetMostActiveUsers_PopulatesUserFields(t *testing.T) {
	// given
	repos := daotest.NewRepos(t)
	db := repos.DB()
	user := daotest.CreateUser(t, repos,
		daotest.WithUsername("acehunter"),
		daotest.WithDisplayName("Ace Hunter"),
	)
