...
func (r *postDAO) AddMedia(ctx context.Context, postID uuid.UUID, mediaURL string, mediaType string, thumbnailURL string, sortOrder int) (int64, error) {
	var id int64
...
func (r *postDAO) DeleteMedia(ctx context.Context, id int64, postID uuid.UUID) (string, error) {
	var mediaURL string
	err := r.db.QueryRowContext(ctx, `SELECT media_url FROM post_media WHERE id = $1 AND post_id = $2`, id, postID).Scan(&mediaURL)
	if err != nil {
		return "", fmt.Errorf("media not found: %w", err)
	}
	_, err = r.db.ExecContext(ctx, `DELETE FROM post_media WHERE id = $1 AND post_id = $2`, id, postID)
	if err != nil {
...
func (r *postDAO) UpdateMediaURL(ctx context.Context, id int64, mediaURL string) error {
	_, err := r.db.ExecContext(ctx, `UPDATE post_media SET media_url = $1 WHERE id = $2`, mediaURL, id)
	if err != nil {
...
func (r *postDAO) UpdateMediaThumbnail(ctx context.Context, id int64, thumbnailURL string) error {
	_, err := r.db.ExecContext(ctx, `UPDATE post_media SET thumbnail_url = $1 WHERE id = $2`, thumbnailURL, id)
	if err != nil {
...
func (r *postDAO) GetMedia(ctx context.Context, postID uuid.UUID) ([]model.PostMediaRow, error) {
	rows, err := r.db.QueryContext(ctx,
		`SELECT id, post_id, media_url, media_type, thumbnail_url, sort_order FROM post_media WHERE post_id = $1 ORDER BY sort_order`,
		postID,
	)
	if err != nil {
...
func (r *postDAO) GetMediaBatch(ctx context.Context, postIDs []uuid.UUID) (map[uuid.UUID][]model.PostMediaRow, error) {
	if len(postIDs) == 0 {
		return nil, nil
	}
	...
	rows, err := r.db.QueryContext(ctx,
		rebind(`SELECT id, post_id, media_url, media_type, thumbnail_url, sort_order FROM post_media WHERE post_id IN (`+placeholders+`) ORDER BY sort_order`),
		args...,
	)
	if err != nil {
...
func (r *postDAO) Like(ctx context.Context, userID uuid.UUID, postID uuid.UUID) error {
	_, err := r.db.ExecContext(ctx,
...
func (r *postDAO) Unlike(ctx context.Context, userID uuid.UUID, postID uuid.UUID) error {
	_, err := r.db.ExecContext(ctx,
...
func (r *postDAO) GetLikedBy(ctx context.Context, postID uuid.UUID, excludeUserIDs []uuid.UUID) ([]model.PostLikeUser, error) {
	exclSQL, exclArgs := excludeClauseQ("pl.user_id", excludeUserIDs)
	queryArgs := []interface{}{postID}
	queryArgs = append(queryArgs, exclArgs...)
	rows, err := r.db.QueryContext(ctx,
		rebind(`SELECT u.id, u.username, u.display_name, u.avatar_url, COALESCE(r.role, '')
		FROM post_likes pl
...
func (r *postDAO) RecordView(ctx context.Context, postID uuid.UUID, viewerHash string) (bool, error) {
	res, err := r.db.ExecContext(ctx,
...
func (r *postDAO) CreateComment(ctx context.Context, id uuid.UUID, postID uuid.UUID, parentID *uuid.UUID, userID uuid.UUID, body string) error {
	_, err := r.db.ExecContext(ctx,
		`INSERT INTO post_comments (id, post_id, parent_id, user_id, body) VALUES ($1, $2, $3, $4, $5)`,
...
func (r *postDAO) UpdateComment(ctx context.Context, id uuid.UUID, userID uuid.UUID, body string) error {
	return r.updateComment(ctx, id, &userID, body)
}

func (r *postDAO) UpdateCommentAsAdmin(ctx context.Context, id uuid.UUID, body string) error {
...
func (r *postDAO) updateComment(ctx context.Context, id uuid.UUID, userID *uuid.UUID, body string) error {
	...
	if userID != nil {
		res, err = r.db.ExecContext(ctx,
			`UPDATE post_comments SET body = $1, updated_at = NOW() WHERE id = $2 AND user_id = $3`,
			body, id, *userID,
		)
	} else {
		res, err = r.db.ExecContext(ctx,
			`UPDATE post_comments SET body = $1, updated_at = NOW() WHERE id = $2`,
			body, id,
		)
	}
	if err != nil {
...
func (r *postDAO) DeleteComment(ctx context.Context, id uuid.UUID, userID uuid.UUID) error {
	res, err := r.db.ExecContext(ctx, `DELETE FROM post_comments WHERE id = $1 AND user_id = $2`, id, userID)
	if err != nil {
...
func (r *postDAO) DeleteCommentAsAdmin(ctx context.Context, id uuid.UUID) error {
	_, err := r.db.ExecContext(ctx, `DELETE FROM post_comments WHERE id = $1`, id)
	if err != nil {
...
func (r *postDAO) GetComments(ctx context.Context, postID uuid.UUID, viewerID uuid.UUID, limit, offset int, excludeUserIDs []uuid.UUID) ([]model.PostCommentRow, int, error) {
	var total int
	exclSQL, exclArgs := excludeClauseQ("user_id", excludeUserIDs)
	countArgs := []interface{}{postID}
	countArgs = append(countArgs, exclArgs...)
	if err := r.db.QueryRowContext(ctx, rebind(`SELECT COUNT(*) FROM post_comments WHERE post_id = ?`+exclSQL), countArgs...).Scan(&total); err != nil {
...
func (r *postDAO) LikeComment(ctx context.Context, userID uuid.UUID, commentID uuid.UUID) error {
	_, err := r.db.ExecContext(ctx,
...
func (r *postDAO) UnlikeComment(ctx context.Context, userID uuid.UUID, commentID uuid.UUID) error {
	_, err := r.db.ExecContext(ctx,
...
func (r *postDAO) GetCommentPostID(ctx context.Context, commentID uuid.UUID) (uuid.UUID, error) {
	var postID uuid.UUID
	err := r.db.QueryRowContext(ctx, `SELECT post_id FROM post_comments WHERE id = $1`, commentID).Scan(&postID)
	if err != nil {
...
func (r *postDAO) GetCommentAuthorID(ctx context.Context, commentID uuid.UUID) (uuid.UUID, error) {
	var userID uuid.UUID
	err := r.db.QueryRowContext(ctx, `SELECT user_id FROM post_comments WHERE id = $1`, commentID).Scan(&userID)
	if err != nil {
...
func (r *postDAO) AddCommentMedia(ctx context.Context, commentID uuid.UUID, mediaURL string, mediaType string, thumbnailURL string, sortOrder int) (int64, error) {
	var id int64
	err := r.db.QueryRowContext(ctx,
...
func (r *postDAO) UpdateCommentMediaURL(ctx context.Context, id int64, mediaURL string) error {
	_, err := r.db.ExecContext(ctx, `UPDATE post_comment_media SET media_url = $1 WHERE id = $2`, mediaURL, id)
	if err != nil {
...
func (r *postDAO) UpdateCommentMediaThumbnail(ctx context.Context, id int64, thumbnailURL string) error {
	_, err := r.db.ExecContext(ctx, `UPDATE post_comment_media SET thumbnail_url = $1 WHERE id = $2`, thumbnailURL, id)
	if err != nil {
...
func (r *postDAO) GetCommentMedia(ctx context.Context, commentID uuid.UUID) ([]model.PostMediaRow, error) {
	rows, err := r.db.QueryContext(ctx,
		`SELECT id, comment_id, media_url, media_type, thumbnail_url, sort_order FROM post_comment_media WHERE comment_id = $1 ORDER BY sort_order`,
		commentID,
	)
	if err != nil {
...
func (r *postDAO) GetCommentMediaBatch(ctx context.Context, commentIDs []uuid.UUID) (map[uuid.UUID][]model.PostMediaRow, error) {
	if len(commentIDs) == 0 {
		return nil, nil
	}
	...
	rows, err := r.db.QueryContext(ctx,
		rebind(`SELECT id, comment_id, media_url, media_type, thumbnail_url, sort_order FROM post_comment_media WHERE comment_id IN (`+placeholders+`) ORDER BY sort_order`),
		args...,
	)
	if err != nil {
