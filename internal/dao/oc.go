...
func (r *ocDAO) Create(ctx context.Context, id uuid.UUID, userID uuid.UUID, name string, description string, series string, customSeriesName string) error {
...
func (r *ocDAO) Update(ctx context.Context, id uuid.UUID, userID uuid.UUID, name string, description string, series string, customSeriesName string, asAdmin bool) error {
...
func (r *ocDAO) UpdateImage(ctx context.Context, id uuid.UUID, imageURL string, thumbnailURL string) error {
	_, err := r.db.ExecContext(ctx,
...
func (r *ocDAO) Delete(ctx context.Context, id uuid.UUID, userID uuid.UUID) error {
...
func (r *ocDAO) DeleteAsAdmin(ctx context.Context, id uuid.UUID) error {
...
func (r *ocDAO) GetByID(ctx context.Context, id uuid.UUID, viewerID uuid.UUID) (*model.OCRow, error) {
	var o model.OCRow
...
func (r *ocDAO) GetAuthorID(ctx context.Context, ocID uuid.UUID) (uuid.UUID, error) {
...
func (r *ocDAO) HasOC(ctx context.Context, userID uuid.UUID, name string) (bool, error) {
	var exists bool
...
func (r *ocDAO) ListByUser(ctx context.Context, userID uuid.UUID, viewerID uuid.UUID, limit, offset int) ([]model.OCRow, int, error) {
	var total int
...
func (r *ocDAO) ListSummariesByUser(ctx context.Context, userID uuid.UUID) ([]model.OCSummaryRow, error) {
...
func (r *ocDAO) AddGalleryImage(ctx context.Context, ocID uuid.UUID, imageURL string, thumbnailURL string, caption string, sortOrder int) (int64, error) {
	var id int64
	err := r.db.QueryRowContext(ctx,
...
func (r *ocDAO) UpdateGalleryImageURL(ctx context.Context, id int64, imageURL string) error {
...
func (r *ocDAO) UpdateGalleryImageThumbnail(ctx context.Context, id int64, thumbnailURL string) error {
...
func (r *ocDAO) UpdateGalleryImage(ctx context.Context, id int64, ocID uuid.UUID, caption *string, sortOrder *int) error {
...
func (r *ocDAO) DeleteGalleryImage(ctx context.Context, id int64, ocID uuid.UUID) error {
...
func (r *ocDAO) GetGallery(ctx context.Context, ocID uuid.UUID) ([]model.OCImageRow, error) {
	rows, err := r.db.QueryContext(ctx,
...
func (r *ocDAO) GetGalleryBatch(ctx context.Context, ocIDs []uuid.UUID) (map[uuid.UUID][]model.OCImageRow, error) {
	if len(ocIDs) == 0 {
		return nil, nil
	}
	placeholders := "$1"
...
func (r *ocDAO) Vote(ctx context.Context, userID uuid.UUID, ocID uuid.UUID, value int) error {
	if value == 0 {
		_, err := r.db.ExecContext(ctx,
...
func (r *ocDAO) Favourite(ctx context.Context, userID uuid.UUID, ocID uuid.UUID) error {
	_, err := r.db.ExecContext(ctx,
...
func (r *ocDAO) Unfavourite(ctx context.Context, userID uuid.UUID, ocID uuid.UUID) error {
	_, err := r.db.ExecContext(ctx,
