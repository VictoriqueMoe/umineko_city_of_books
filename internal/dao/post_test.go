...
func TestPostDAO_AddEmbed_GetEmbeds(t *testing.T) {
	// given
	repos := daotest.NewRepos(t)
	user := daotest.CreateUser(t, repos)
	postID := createPost(t, repos, user.ID, "general", "b")
...
func TestPostDAO_DeleteEmbeds(t *testing.T) {
	// given
	repos := daotest.NewRepos(t)
	user := daotest.CreateUser(t, repos)
	postID := createPost(t, repos, user.ID, "general", "b")
...
func TestPostDAO_UpdateEmbed(t *testing.T) {
	// given
	repos := daotest.NewRepos(t)
	user := daotest.CreateUser(t, repos)
	postID := createPost(t, repos, user.ID, "general", "b")
...
func TestPostDAO_GetEmbedsBatch(t *testing.T) {
	// given
	repos := daotest.NewRepos(t)
	user := daotest.CreateUser(t, repos)
	p1 := createPost(t, repos, user.ID, "general", "a")
...
func TestPostDAO_GetEmbedsBatch_Empty(t *testing.T) {
	// given
	repos := daotest.NewRepos(t)
...
func TestPostDAO_GetStaleEmbeds(t *testing.T) {
	// given
	repos := daotest.NewRepos(t)
	user := daotest.CreateUser(t, repos)
	postID := createPost(t, repos, user.ID, "general", "b")
...
func TestPostDAO_GetStaleEmbeds_None(t *testing.T) {
	// given
	repos := daotest.NewRepos(t)
	user := daotest.CreateUser(t, repos)
	postID := createPost(t, repos, user.ID, "general", "b")
...
func TestPostDAO_GetStaleEmbeds_SkipsYouTube(t *testing.T) {
	// given
	repos := daotest.NewRepos(t)
	user := daotest.CreateUser(t, repos)
	postID := createPost(t, repos, user.ID, "general", "b")
