...
func (r *sidebarLastVisitedDAO) Upsert(ctx context.Context, userID uuid.UUID, key string) error {
...
func (r *sidebarLastVisitedDAO) ListForUser(ctx context.Context, userID uuid.UUID) (map[string]string, error) {
