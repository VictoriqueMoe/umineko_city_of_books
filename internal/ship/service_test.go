...
func newTestService(t *testing.T) (*service, *testMocks) {
	...
	svc := NewService(shipRepo, userRepo, auditRepo, authzSvc, blockSvc, notifSvc, mentionSvc, uploadSvc, mediaProc, settingsSvc, quoteClient, contentfilter.New()).(*service)
